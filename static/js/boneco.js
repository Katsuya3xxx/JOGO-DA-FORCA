function desenharBoneco(tentativasRestantes) {
    ...
    travessaSuperior.style.width = "5px"; 
    ...
    if (tentativasRestantes <= 5) {
        ...
        cabeca.style.border = "5px solid blue";
    ...
    if (tentativasRestantes <= 1) {
        ...
        pernaEsquerda.style.top = "167px";
        pernaEsquerda.style.left = "16%";
